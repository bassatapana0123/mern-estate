    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
          ...
          <div className='text-gray-400 text-xs sm:text-sm'>
            Satapana Estate is the best place to find your next
      ...
      {/* liseting results for offer, sale and rent */}
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
        ...
        offerListings && offerListings.length > 0 && (
            <div className=''>
              <div className='my-3'>
                <h2 className='text-2xl font-smibold text-slate-600'>Recent offers</h2>
        ...
        rentListings && rentListings.length > 0 && (
            <div className=''>
              <div className='my-3'>
                <h2 className='text-2xl font-smibold text-slate-600'>Recent places for rent</h2>
        ...
        saleListings && saleListings.length > 0 && (
            <div className=''>
              <div className='my-3'>
                <h2 className='text-2xl font-smibold text-slate-600'>Recent places for sale</h2>
